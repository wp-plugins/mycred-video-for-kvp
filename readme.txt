...
**What is myCRED?**
[myCRED](http://mycred.me/ "myCRED") is an adaptive points management system that lets you award / charge your users for interacting with your WordPress powered website.
...
1. Upload `mycred-for-kvp` folder to the `/wp-content/plugins/` directory
